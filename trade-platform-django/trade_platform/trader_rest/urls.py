...
urlpatterns = patterns('trader_rest.views',
	...
	url(r'^orderImage/$', views.OrderImageList.as_view()),
    url(r'^orderImage/(?P<pk>[0-9]+)/$', views.OrderImageDetail.as_view()), 
